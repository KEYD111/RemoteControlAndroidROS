...
public class BatteryView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //        }
        //判断充放电 charge 1   uncharge 0
        if (flagcharge == 0) {
            //放电
            drawHorizontalBatteryUnCharge(canvas);
        }
        if (flagcharge == 1) {
            //充电
            drawHorizontalBatteryCharge(canvas);
        }
    }
     ...
     * @Return:
     */
    private void drawHorizontalBatteryUnCharge(Canvas canvas) {
